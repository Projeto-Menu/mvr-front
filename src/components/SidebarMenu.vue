<template>
  <div v-if="visible" class="fixed inset-y-0 left-0 mt-16 bg-[#baf77c] p-4 w-60">
    <!-- Nova seção para a semana -->
    <div class="mt-4 text-green-600">
      <p class="text-2xl font-semibold">Semana</p>
      <p class="text-lg text-white">De {{ semanaInfo }}</p>
    </div>
    ...
    <div class="mt-4 text-green-600">
      ...
      <div class="mt-2 space-y-2">
        <Button
          class="w-full bg-[#61d4b0] text-white px-3 py-2 rounded"
          label="Segunda"
        />
        <Button
          class="w-full bg-[#61d4b0] text-white px-3 py-2 rounded"
